...
suite('randomEmail()', function () {
    ...
    test('custom length and domain', function () {
        expect(useful.randomEmail(4, 'abc.com'))
            .to.match(/^[0-9]{4}@abc[.]com$/);
    });

    test('domain undefined', function () {
        expect(useful.randomEmail(4, undefined))
            .to.match(/^[0-9]{4}@inveo[.]cz$/);
    });

    test('domain null', function () {
        expect(useful.randomEmail(4, null))
            .to.match(/^[0-9]{4}@inveo[.]cz$/);
    });

    test('domain object', function () {
        expect(useful.randomEmail(4, {}))
            .to.match(/^[0-9]{4}@inveo[.]cz$/);
    });

    test('length undefined', function () {
        expect(useful.randomEmail(undefined, 'abc.com'))
            .to.match(/^[0-9]{10}@abc[.]com$/);
    });

    test('length null', function () {
        expect(useful.randomEmail(null, 'abc.com'))
            .to.match(/^[0-9]{10}@abc[.]com$/);
    });

    test('length object', function () {
        expect(useful.randomEmail({}, 'abc.com'))
            .to.match(/^[0-9]{10}@abc[.]com$/);
    });

    test('length string', function () {
        expect(useful.randomEmail('undef', 'abc.com'))
            .to.match(/^[0-9]{10}@abc[.]com$/);
    });
});
