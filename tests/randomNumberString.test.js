...
suite('randomNumberString()', function () {
  ...
  test('alphabet undefined', function () {
    expect(useful.randomNumberString(10, undefined)).to.match(/^[0-9]{10}$/);
  });
  ...
  test('length undefined', function () {
    expect(useful.randomNumberString(undefined, '234')).to.match(/^[234]{10}$/);
  });
  ...
  test('length 1000', function () {
    expect(useful.randomNumberString(1000, '2346')).to.match(/^[2346]{1000}$/);
  });
});
